                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-4 bg-gray-50 border-b-2 border-rawr-black flex justify-between items-center">
                            <span className="text-xs font-black uppercase tracking-widest text-gray-500">Results for &quot;{query}&quot;</span>
                            <span className="text-xs font-black uppercase tracking-widest text-rawr-red">{results.length} found</span>
                        </div>
                        ...
                        {results.length > 0 ? (
                                ...
                                {results.map((product) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h4 className="font-heading font-black uppercase text-lg leading-tight truncate">{product.title}</h4>
                                            <p className="text-sm font-bold text-gray-500 uppercase">{product.category}</p>
                            ...
                            <div className="p-12 text-center">
                                ...
                                <p className="text-sm text-gray-500 mt-2">No items matching that query in the vault.</p>
                            </div>
                        )}
                    </motion.div>
                )}
