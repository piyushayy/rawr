    ...
    <footer className="w-full border-t-2 border-rawr-black bg-rawr-black text-rawr-white py-12">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-2">
          <h2 className="text-6xl font-heading font-black mb-4 tracking-tighter text-rawr-red">
            RAWR
          </h2>
        ...
        <div className="flex flex-col gap-4">
          <h3 className="font-heading font-bold text-xl uppercase text-rawr-white">
            The Cult
          </h3>
          <Link
            href="/about"
