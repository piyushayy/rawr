...
export const ShippingAccordion = () => {
    return (
        <Accordion type="single" collapsible className="w-full border-t border-b border-rawr-black mt-8">
            ...
            <AccordionItem value="item-3" className="border-none">
                ...
                <AccordionContent className="text-gray-600 font-body text-sm leading-relaxed pb-4">
                    <p className="mb-2">Every item is rigorously inspected by our team of experts.</p>
                    <p>We guarantee 100% authenticity or your money back. Each purchase comes with a digital certificate of authenticity linked to your profile.</p>
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    );
