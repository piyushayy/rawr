    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-8 gap-2 px-2 text-xs font-bold uppercase hover:bg-white/10 hover:text-white text-gray-400"
        >
      ...
      <DropdownMenuContent
        align="end"
        className="bg-rawr-black border-gray-800 text-white min-w-[150px]"
      >
