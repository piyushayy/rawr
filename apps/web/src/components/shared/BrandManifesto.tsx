...
const DNA = [
  {
    ...
    title: "The Hunt",
    description:
      "We scour thousands of bins so you don't have to. Only 1% makes the cut.",
  },
  {
    icon: <Sparkles className="w-8 h-8" />,
    title: "The Revival",
    description:
      "Each piece is washed, steamed, and graded. No weird smells. Just fresh heat.",
  },
  {
    icon: <Leaf className="w-8 h-8" />,
    title: "The Impact",
    description:
      "Saving the planet one vintage tee at a time. Zero fast fashion guilt.",
  },
  {
    icon: <Shirt className="w-8 h-8" />,
    title: "The Rarity",
    description:
      "Everything is 1-of-1. When it's gone, it's gone forever. Don't sleep.",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-heading font-black uppercase tracking-tight mb-6 leading-none">
            Respect <br />
            <span className="text-rawr-red">The Archive</span>
          </h2>
          <p className="text-xl md:text-xl font-bold text-gray-400 uppercase tracking-widest max-w-xl mx-auto">
            We are not just a store. We are a curation engine for the rare and
            the reckless.
          </p>
        </div>
                ...
                >
                  ...
                  <AnimatePresence>
                    {activeHotspot === items[0].id && (
                      ...
                      >
                        <p className="font-heading font-black text-sm uppercase truncate leading-none mb-1">
                          {items[0].title}
                        </p>
                        <p className="font-mono text-xs text-rawr-red font-bold mb-2">
                          <Price amount={items[0].price} />
                        </p>
                        <Link
                          href={`/product/${items[0].id}`}
                          className="block w-full text-center bg-rawr-black text-white py-1 font-bold text-xs uppercase hover:bg-rawr-red transition-colors"
                        >
                          View Details
                        </Link>
                      </motion.div>
