...
export const getLatestDrop = async (): Promise<Product[]> => {
  try {
    ...
    console.error(
      "Caught exception fetching latest drops (Supabase may be down):",
      err,
    );
    return [];
  }
...
export const getRecommendations = async (
  ...
  if (category === "tops" || category === "outerwear")
    targetCategories = ["bottoms", "shoes", "accessories"];
  else if (category === "bottoms")
    targetCategories = ["tops", "outerwear", "shoes"];
  else if (category === "shoes")
    targetCategories = ["bottoms", "tops", "accessories"];
