export async function verifyTurnstileToken(token?: string): Promise<boolean> {
    ...
    if (!secretKey) {
        console.warn("System WARNING: Missing TURNSTILE_SECRET_KEY in Environment. Bot protection bypassed.");
    ...
    try {
        ...
        if (!outcome.success) {
            console.warn("Turnstile Verification hard failure:", outcome['error-codes']);
        }
