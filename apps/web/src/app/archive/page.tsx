            ...
            <header className="bg-rawr-black text-white py-16 px-4 md:px-8 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <p className="font-body text-xl max-w-2xl text-gray-400">
                        Grails that slipped away. These items are currently secured in the archive.
                        See what you missed, and open an item to request a hunt. If we find it again, you'll be the first to know.
                    </p>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-8 mt-12">
                {products.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-24 text-center border-2 border-dashed border-rawr-black">
                        <p className="font-heading font-black text-3xl uppercase">The Vault is empty.</p>
                        <p className="text-gray-500 mt-2 font-bold uppercase">There are no sold-out items yet. Grab the drops while they last.</p>
                    </div>
                ) : (
