    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl bg-rawr-white border-2 border-rawr-black p-0 overflow-hidden">
        <DialogHeader className="p-6 bg-rawr-black text-white">
          <DialogTitle className="text-3xl font-heading font-black uppercase">
            Fit Protocol
          </DialogTitle>
        ...
        <div className="p-6">
            ...
            <table className="w-full text-sm font-body text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-rawr-black">
                  <th className="py-2 px-4 uppercase font-black bg-gray-100">
                    Size
                  </th>
                  <th className="py-2 px-4 uppercase font-black bg-gray-100">
                    Chest
          ...
          <div className="mt-6 p-4 bg-gray-100 border border-gray-300 rounded text-xs text-gray-600">
            <p className="mb-2">
              <span className="font-bold uppercase">Chest:</span> Measured
              across the chest one inch below armhole when laid flat.
            </p>
            <p>
              <span className="font-bold uppercase">Length:</span> Measured from
              highest point of shoulder to bottom hem.
            </p>
          </div>
        </div>
      </DialogContent>
