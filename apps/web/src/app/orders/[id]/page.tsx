    ...
    <div className="bg-rawr-white min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <Link href="/orders">
          <Button
            variant="ghost"
            className="mb-4 pl-0 hover:bg-transparent hover:text-rawr-red"
          >
                ...
                <div className="space-y-8 relative z-10">
                  {steps.map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-full flex items-center justify-center border-2 ${isCompleted ? "bg-rawr-black text-white border-rawr-black" : "bg-white text-gray-300 border-gray-200"}`}
                        >
                          <step.icon className="w-6 h-6" />
                        </div>
                        <div>
                          <p
                            className={`font-bold uppercase text-lg ${isCompleted ? "text-black" : "text-gray-400"}`}
                          >
                            {step.label}
                          </p>
                          {isCurrent && (
