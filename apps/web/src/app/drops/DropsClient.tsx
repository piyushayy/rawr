    ...
    <div className="flex gap-4 md:gap-8 justify-center mt-8">
      {Object.entries(timeLeft).map(([unit, value]) => (
        <div key={unit} className="text-center">
          ...
          <div className="text-sm md:text-lg font-bold uppercase mt-2 text-rawr-black">
            {unit}
          </div>
        </div>
      ))}
    ...
    <div className="min-h-screen bg-rawr-white flex flex-col items-center justify-center p-4 text-center">
      ...
      >
        ...
        <div className="mt-16">
          <Button
            size="lg"
            className="h-20 text-2xl px-16 uppercase tracking-widest bg-transparent border-2 border-rawr-black text-rawr-black hover:bg-rawr-black hover:text-white transition-all"
          >
            Get Notified
          </Button>
        </div>
