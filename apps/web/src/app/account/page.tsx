    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start bg-rawr-black text-white p-8 rounded-lg relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            >
              <div className="bg-white/10 px-4 py-2 rounded border border-white/5 hover:border-rawr-red transition-colors">
                <p className="text-xs uppercase text-gray-400 font-bold mb-1">
                  Clout Score{" "}
                  <span className="text-[10px] text-rawr-red ml-1">
                    (View Perks)
                  </span>
                </p>
                <p className="text-2xl font-black text-rawr-red leading-none">
                  {clout}
                </p>
              </div>
            </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/orders" className="group">
          <div className="border-2 border-rawr-black p-6 hover:bg-black hover:text-white transition-colors h-full">
            ...
            <h3 className="text-xl font-heading font-black uppercase mb-2">
              Orders
            </h3>
            <p className="text-sm font-bold text-gray-500 group-hover:text-gray-400">
              Track shipments and view history.
            </p>
          </div>
        </Link>
        ...
        <Link href="/settings" className="group">
          <div className="border-2 border-rawr-black p-6 hover:bg-black hover:text-white transition-colors h-full">
            <div className="w-8 h-8 mb-4 group-hover:text-rawr-red transition-colors flex items-center justify-center">
              ...
              {/* Using emoji or lucide icon if available, let's use Settings icon */}
            </div>
            <h3 className="text-xl font-heading font-black uppercase mb-2">
              Settings
            </h3>
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-gray-300 font-bold max-w-md">
              Share your code. Earn 500 Clout for every new member who joins the
              hierarchy.
            </p>
          </div>
      ...
      <div className="bg-gray-50 p-8 border border-gray-200 text-center">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Issues with your order or questions about the cult?
        </p>
