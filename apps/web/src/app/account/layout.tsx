        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 shrink-0 space-y-2">
            <div className="p-4 border-2 border-rawr-black bg-white mb-6">
              ...
              <p className="font-bold truncate" title={user.email}>
                {user.email}
              </p>
            </div>
            ...
            <Link href="/orders" className="block">
              <Button
                variant="outline"
                className="w-full justify-start gap-3 h-12 border-2 border-rawr-black hover:bg-rawr-black hover:text-white transition-all text-left"
              >
