        ...
        <div className="flex min-h-screen bg-gray-100 font-body">
            ...
            <aside className="w-64 bg-rawr-black text-white shrink-0 hidden md:flex flex-col">
                <div className="p-6 border-b border-gray-800">
                    <h1 className="text-2xl font-heading font-black tracking-tighter">RAWR <span className="text-rawr-red">ADMIN</span></h1>
                </div>
                ...
                <div className="p-4 border-t border-gray-800">
                    <Link href="/" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors font-bold text-sm uppercase text-gray-400 hover:text-white">
