...
export default function NotificationsPage() {
    ...
    const templates = [
        { title: "Drop is Live", subject: "THE DROP IS OPEN 🚨", body: "It's live. Go get it before it's gone.\n\n[Link]" },
        { title: "Restock", subject: "RESTOCK ALERT ⚡", body: "We just added new heat to the site. Check it out." },
        { title: "Newsletter", subject: "WEEKLY REPORT 📜", body: "Here is what we found this week..." }
    ];
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                    <h3 className="font-bold uppercase text-gray-500 text-sm">Templates</h3>
                    {templates.map((t, i) => (
                        <div
                            key={i}
                    ...
                    <div className="bg-yellow-50 p-4 border border-yellow-200 mt-8">
                        ...
                        <p className="text-xs text-yellow-800 leading-relaxed">
                            This sends an actual email to REAL users via Resend.
                            Don't spam. Proceed with caution.
                        </p>
                    </div>
                </div>
                ...
                <div className="md:col-span-2 bg-white border border-gray-200 p-8 shadow-sm space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-bold uppercase mb-2">Subject Line</label>
                        <Input
                            value={subject}
                    ...
                    <div>
                        <label className="block text-sm font-bold uppercase mb-2">Email Body (HTML Supported)</label>
                        <Textarea
                            value={body}
