...
export default function ProductForm({
  ...
  const [variants, setVariants] = useState<any[]>(
    initialData?.variants?.length
      ...
      : [{ id: crypto.randomUUID(), sku: "", size: "OS", stock_quantity: 1 }],
  );
    ...
    >
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2 col-span-2">
          ...
          <p className="text-xs text-gray-500">
            For Phase 3 demo, paste direct image URLs.
          </p>
        </div>
        ...
        <div className="space-y-2 col-span-2">
          ...
          />
          <p className="text-xs text-gray-500">
            Direct link to MP4 background video.
          </p>
        </div>
        ...
        <div className="col-span-2">
          <label className="font-bold text-sm uppercase block mb-2">
            Measurements
          </label>
          <div className="grid grid-cols-3 gap-4 bg-gray-50 p-4 rounded border border-gray-200">
            <div>
              ...
              <input
                name="measure_chest"
                defaultValue={initialData?.measurements?.chest}
            ...
            <div>
              ...
              <input
                name="measure_length"
                defaultValue={initialData?.measurements?.length}
                className="w-full p-1 border rounded"
              />
            </div>
            <div>
              ...
              <input
                name="measure_sleeve"
                defaultValue={initialData?.measurements?.sleeve}
                className="w-full p-1 border rounded"
              />
            </div>
            <div>
              ...
              <input
                name="measure_waist"
                defaultValue={initialData?.measurements?.waist}
                className="w-full p-1 border rounded"
              />
            </div>
            <div>
              ...
              <input
                name="measure_inseam"
                defaultValue={initialData?.measurements?.inseam}
                className="w-full p-1 border rounded"
              />
            </div>
          </div>
        ...
        <div className="space-y-2 col-span-2">
          ...
          />
          <p className="text-xs text-gray-500">
            Overrides the default page title. Keep under 60 characters.
          </p>
        </div>
        ...
        <div className="col-span-2 border-t border-gray-200 mt-6 pt-6">
          ...
          <div className="space-y-4">
            {variants.map((variant, index) => (
              <div
                key={variant.id}
                className="flex items-end gap-4 bg-gray-50 p-4 border border-gray-200 rounded relative"
              >
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const newVariants = [...variants];
                      newVariants[index].stock_quantity =
            ...
            {variants.length === 0 && (
              <p className="text-sm text-gray-500 italic p-4 bg-yellow-50 border border-yellow-200">
                Warning: No variants defined. Users won't be able to easily
                select sizes unless relying on fallback logic.
              </p>
            )}
          </div>
        </div>
        ...
        {initialData && (
          <div className="col-span-2 flex items-center gap-2 mt-6 border-t border-gray-200 pt-6">
            <input
              ...
              className="w-5 h-5"
            />
            <label htmlFor="sold_out" className="font-bold uppercase text-sm">
              Force Mark as Sold Out (Overrides Variant Stock)
            </label>
          </div>
        )}
        ...
        <div className="space-y-2 col-span-2">
          <label className="font-bold text-sm uppercase">
            Release Date (Leave empty for immediate drop)
          </label>
          <input
            type="datetime-local"
            name="release_date"
      ...
      <div className="pt-8">
        <Button
          type="submit"
          disabled={loading}
          className="w-full h-14 text-xl tracking-widest bg-rawr-black text-white hover:bg-rawr-red border-none uppercase shadow-[4px_4px_0px_#FF0000] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all"
        >
