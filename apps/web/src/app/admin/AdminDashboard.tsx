    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
        ...
        <Card className="col-span-1 lg:col-span-4 border-2 border-rawr-black">
          <CardHeader>
            <CardTitle className="font-heading font-black uppercase">
              Revenue Overview
            </CardTitle>
          </CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              {data.topProducts.map((p, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-2 hover:bg-gray-100 transition-colors border-b border-gray-100 last:border-0"
                >
