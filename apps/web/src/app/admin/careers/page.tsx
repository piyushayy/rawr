    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-3xl font-heading font-black uppercase">Careers / Applications</h2>
            </div>
            ...
            <div className="space-y-4">
                ...
                {applications?.map((app) => (
                    <div key={app.id} className={`bg-white border p-6 rounded-lg ${app.status === 'unread' ? 'border-l-4 border-l-rawr-red shadow-md' : 'border-gray-200 opacity-80'}`}>
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="text-xs font-bold text-gray-400 uppercase">{new Date(app.created_at).toLocaleDateString()}</span>
                        </div>

                        <div className="mb-2">
                            <span className="text-xs font-bold uppercase bg-gray-100 px-2 py-1 rounded">Position: {app.subject}</span>
                        </div>
