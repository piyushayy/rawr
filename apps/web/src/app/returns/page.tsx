                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-rawr-black text-white p-8 border-2 border-rawr-black shadow-[8px_8px_0px_0px_#888888]">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed">
                            Thrift stores usually say "All Sales Final". We aren't a thrift store. We are an archive.<br />
                            If you don't love it, you have <strong>30 days</strong> to return it for Store Credit.
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-100 border-2 border-dashed border-gray-400 p-8 text-center">
                        ...
                        <p className="text-gray-600 mb-6">
                            1. Go to your <Link href="/account" className="underline font-bold">Account</Link>.<br />
                            2. Select the order and click "Request Return".<br />
                            3. We'll send you a prepaid label (deducted from refund).<br />
