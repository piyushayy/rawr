          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed mb-4">
                At RAWR, we value your privacy. You have full control over your
                data. Updating your profile here changes it across the entire
                platform immediately.
              </p>
              <p className="text-sm text-gray-600 leading-relaxed">
                If you choose to delete your account, your personal data will be
                wiped. Past orders will be anonymized for our accounting
                records.
              </p>
            </div>
          </div>
