    ...
    <div className="min-h-screen bg-rawr-white flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <p className="font-body text-lg">
          Your order{" "}
          <span className="font-bold text-rawr-red">
            #{orderId.slice(0, 8)}
          </span>{" "}
          has been secured.
        </p>
        <div className="bg-gray-100 p-4 border-2 border-rawr-black text-sm">
          A confirmation email has been sent to your inbox. Tracking details
          will follow shortly.
        </div>
        ...
        {!user && (
          <div className="bg-rawr-red text-white p-6 border-2 border-rawr-black space-y-4 mt-8 text-left">
            ...
            <p className="font-body text-sm font-bold">
              Create an account now to track your package live and earn Clout
              points for future exclusive drops.
            </p>
            <Link href="/login" className="inline-block mt-2">
              <Button
                variant="secondary"
                className="w-full bg-white text-black hover:bg-gray-200 uppercase font-black tracking-widest flex items-center justify-center gap-2 h-12"
              >
        ...
        <div className="pt-4">
          <Link href="/">
            <Button
              ...
              className="w-full text-lg h-14 uppercase border-2 border-rawr-black"
            >
              Return to Base
            </Button>
          </Link>
